...
// ─────────────────────────────────────────────────────────────────────────────
// RECIPE DATABASE  (replace / extend with your real data source)
// ─────────────────────────────────────────────────────────────────────────────
class RecipeData {
  final String id;
  final String title;
...
List<MatchResult> findMatches(List<String> pantry) {
  ...
  for (final recipe in kRecipeDatabase) {
    ...
    final matched =
        recipeIngs.where((ing) => normalised.contains(ing)).toList();
    final missing =
        recipeIngs.where((ing) => !normalised.contains(ing)).toList();
                      ...
                      children: [
                        Row(children: [
                          const Icon(Icons.menu_book_rounded,
                              color: Color(0xFF3D3A8C), size: 20),
                          const SizedBox(width: 6),
                          Text("Amma's Notebook",
                        ...
                        const CircleAvatar(
                          radius: 20,
                          backgroundImage:
                              NetworkImage('https://i.pravatar.cc/80?img=47'),
                        ),
                      ],
                    ),
                  ),
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Wrap(
                      ...
                      runSpacing: 8,
                      children: [
                        ..._pantry.map((ing) => _IngredientChip(
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: const Color(0xFFDDDCF0), width: 1.5),
                            ),
                            child: Text('+ Add more',
                      ...
                      children: [
                        Text('Top Matches',
                            style: tt.headlineMedium?.copyWith(
                                color: const Color(0xFF1A1A2E), fontSize: 22)),
                        Container(
                          padding: const EdgeInsets.symmetric(
                  ...
                  (_, i) {
                    ...
                    return Padding(
                      ...
                      child: _RecipeMatchCard(
                        ...
                        tt: tt,
                        onFavTap: () =>
                            setState(() => result.isFavourite = !result.isFavourite),
                      ),
                    );
                  },
...
class _IngredientChip extends StatelessWidget {
  ...
  const _IngredientChip(
      {required this.label, required this.onRemove, required this.tt});
...
class _RecipeMatchCard extends StatelessWidget {
  ...
  const _RecipeMatchCard(
      {required this.result, required this.tt, required this.onFavTap});
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.access_time_rounded,
                        color: Color(0xFF9090AA), size: 14),
                ...
                Text(recipe.description,
                    style: tt.bodyMedium?.copyWith(
                        color: const Color(0xFF6B6B8A), height: 1.6)),
                ...
                Wrap(
                  ...
                  runSpacing: 6,
                  children: [
                    ...result.matchedIngredients.map((ing) => _IngPill(
                          label: _capitalise(ing),
                          matched: true,
                          tt: tt,
                        )),
                    ...result.missingIngredients.map((ing) => _IngPill(
                          label: _capitalise(ing),
                          matched: false,
                          tt: tt,
                        )),
                ...
                if (hasMissing) ...[
                  ...
                  Text(
                    ...
                    style: tt.bodySmall?.copyWith(
                        color: const Color(0xFF9090AA), height: 1.5),
                  ),
                ],
...
class _IngPill extends StatelessWidget {
  ...
  const _IngPill(
      {required this.label, required this.matched, required this.tt});
